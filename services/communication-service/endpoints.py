"""
API Endpoints for Communication Service
...
from models import (
    InboxConversation, InboxMessage, InboxQuickReply,
    Channel, ChannelMember, ChatEntry, Mention
)
from schemas import (
    ...
    MentionResponse, ConversationStats, ChannelStats
)
...
async def use_quick_reply(
    ...
    return {"message": "Quick reply usage recorded"}
