"""
Quote Models for CRM Service
Quote-specific models and relationships
"""
...
class Quote(Base):
    ...
    def __repr__(self):
        return f"<Quote: {self.quote_number} - {self.name} (${self.total_amount})>"
...
class QuoteLine(Base):
    ...
    def __repr__(self):
        return f"<QuoteLine: {self.description} - ${self.total_amount}>"
