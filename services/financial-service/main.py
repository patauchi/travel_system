...
FastAPI application for Financial Management
"""
...
app = FastAPI(
    ...
    description="Financial Management Service for Multi-tenant Platform",
    version="1.0.0",
    lifespan=lifespan
)
...
async def initialize_tenant(
    ...
    """
    Initialize Financial schema for a new tenant
    ...
    try:
        ...
        # Initialize schema with Financial tables
        logger.info(f"Initializing Financial schema for tenant {tenant_id}")
...
# Import routers for different Financial modules
from endpoints_orders import router as orders_router
from endpoints_invoices import router as invoices_router
from endpoints_payments import router as payments_router
from endpoints_expenses import router as expenses_router
from endpoints_reports import router as reports_router
