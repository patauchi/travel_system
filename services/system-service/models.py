...
These models represent the tenant-specific tables that will be created in each tenant's schema.
Each tenant will have their own isolated set of these tables.
"""
